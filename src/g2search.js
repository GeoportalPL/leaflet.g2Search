L.Control.G2Search = L.Control.extend({
    options:{
        ...
        // @option customImages: Object = null
        // Object with mapping of `imapid` value to image source - can be url or encoded base64 image
        // Example:
        // customImages: {
        //    "geopard.adresy_solr":"images/poi/adresy-solr.png",
        //    "geopard.PRGGminy":"images/poi/prg-gminy.png"
        //    ......
        //  } 
        customImages: null
    },
    ...
    _mapResults: function(docs){
        return docs.map(function (d) {
                    ...
                    if (obj) {
                        obj.icon = this._imageFactory(d.imapid);
                        ...
                        obj = { text: d.full, details: "", icon: this._imageFactory("geopard.PRNG"), json: d.json };
                    }
                    return obj;
                }, this);
    },
    _getResultTemplate: function(imapid) {
        ...
        switch (imapid) {
            case "geopard.PRGPowiaty":
                obj = { text: "{POWIAT}", details: "powiat" };
                break;
            case "geopard.PRGGminy":
                obj = { text: "{NAZWA}", details: "gmina" };
                break;
            case "geopard.PRNG":
                obj = { text: "{NAZWA_MIANOWNIK}, {RODZAJ_OPIS}", details: "gm. {GMINA}, pow. {POWIAT}, woj. {WOJEWODZTWO}" };
                break;
            ...
            case "geopard.PRNG_Hydro_rzeki":
                obj = { text: "{NAZWA_MIAN}", details: "{RODZAJ}" };
                break;
            case "geopard.adresy_solr":
                obj = { text: "{NAZWA_ULICY} {NR_ADR}, {MIEJSCOWOSC}", details: "gm. {GMINA}, pow. {POWIAT}, woj. {WOJEWODZTWO}" };
                break;
            default:
                obj = null;
        }
